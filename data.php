...
<td><a href=https://torrentgas.000webhostapp.com/>Home</a></td>
            <td><a href=wadia.php>PH Wadia & Sons</a></td>
            <td><a href=mendarda.php>Prabhat</a></td>
            <td><a href=maliya.php>ShreejiKrupa</a></td>
            <td><a href=anjaney.php>Anjaney</a></td>
            <td><a href=visavadar.php>Shayona</a></td>
</tr>
</table>
...
<table style="width:85%" border="5" bordercolordark="black" bgcolor="white">
			<tr>
				...
				<th bgcolor="yellow"><p id="fdate"></p></th>
			</tr> 
			<tr bgcolor="grey">
			<td ></td>
			<td>Start</td>
...
<?php   $df1=$_POST["1a"]-$r1;
        ...
        $df4=$_POST["2b"]-$r4;
        $df5=$_POST["KWH"]-$r7;
        $df6=$_POST["Suction"]-$r8;
        $df7=$_POST["Discharge"]-$r9;
